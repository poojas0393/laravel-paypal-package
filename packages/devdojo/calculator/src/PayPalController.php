...
use Devdojo\Calculator\Invoice;
use Devdojo\Calculator\IPNStatus;
use Devdojo\Calculator\Item;
use Vendor\Srmklive\PayPal\Services\AdaptivePayments;
use Vendor\Srmklive\PayPal\Services\ExpressCheckout;
...
class PayPalController extends Controller
{
    ...
    public function getExpressCheckout(Request $request)
    {
        ...
        try {
            //$response = setExpressCheckout($cart, $recurring);
            $response['paypal_link']='https://www.sandbox.paypal.com/webscr?cmd=_express-checkout&token=EC-4LK40566022937934';
